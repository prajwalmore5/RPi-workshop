...
IO.setup(40,IO.OUT)             # initialize GPIO19 as an output
p = IO.PWM(40,50)              # GPIO19 as PWM output, with 50Hz frequency
p.start(14.5)                             # generate PWM signal with 7.5% duty cycle
